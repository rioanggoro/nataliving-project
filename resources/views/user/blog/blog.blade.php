                            ...
                            <a href="{{ route('blog.show', $blog->slug) }}" class="group">
                                <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:-translate-y-1">
                                    ...
                                    <div class="p-6">
                                        ...
                                        <h3 class="mt-2 text-xl font-semibold text-gray-900 group-hover:text-nataliving-leaf">
                                            {{ $blog->title }}
                                        </h3>
                                        ...
                                        <div class="mt-4">
                                            <span class="text-nataliving-leaf group-hover:text-nataliving-accent font-medium">
                                                Baca Selengkapnya →
                                            </span>
                                        </div>
                                    </div>
